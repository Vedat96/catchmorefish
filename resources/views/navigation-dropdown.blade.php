    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('voorraad') }}" :active="request()->routeIs('voorraad')">
                        {{ __('Voorraad') }}
                    </x-jet-nav-link>
                </div>
                @if (!Auth::user())
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="{{ route('voorraad') }}" :active="request()->routeIs('voorraad')">
                    {{ __('Voorraad') }}
                </x-jet-responsive-nav-link>
            </div>
            @if (Auth::user())
                <div class="pt-2 pb-3 space-y-1">
                    <x-jet-responsive-nav-link href="{{ route('artikel') }}" :active="request()->routeIs('artikel')">
                        {{ __('Artikelen') }}
                    </x-jet-responsive-nav-link>
                </div>
                        <!-- vanaf hier alleen admin -->
                @if(Auth::user()->admin_medewerker == 1)
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <x-jet-responsive-nav-link href="{{ route('locatie') }}" :active="request()->routeIs('locatie')">
                            {{ __('Locaties') }}
                        </x-jet-responsive-nav-link>
                    </div>                <div class="pt-2 pb-3 space-y-1">
                        <x-jet-responsive-nav-link href="{{ route('medewerkers') }}" :active="request()->routeIs('medewerkers')">
                            {{ __('Medewerkers') }}
                        </x-jet-responsive-nav-link>
                    </div>
                @endif
